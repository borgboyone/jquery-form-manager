(function($, undefined) {
	$.aw = $.aw || {};
	// add functionality to either jQuery or our namespace
	if (!$.aw.unique) {
		$.aw.unique = function(array1) {
	...
	if (!$.aw.union) {
		$.aw.union = function(array1, array2) {
			return $.aw.unique($.merge(array1, array2));
		}
	}
	if (!$.aw.exclude) {
	    $.aw.exclude = function(array1, array2) {
	    	for(var i = array1.length - 1; i >= 0; i--) {
	...
	if (!$.aw.intersect) {
	    $.aw.intersect = function(array1, array2) {
			for(var i = array1.length - 1; i>= 0; i--) {
				if ($.inArray(array1[i], array2) == -1) {
					array1.splice(i,1);
				}
...
case 9:this.b=t(b.data.initialInputs.slice(0),d[a]);break;case 10:this.b={attributes:d[a]};break;case 11:this.b={t:d[a]};break;case 12:this.b={attributes:d[a-1],t:d[a]};break;case 13:this.b=d[a-1];break;case 14:this.b=[d[a]];break;case 15:d[a-2].push(d[a]);this.b=d[a-2];break;case 16:d[a-2]in b.filters.properties||m("Invalid attribute name ("+d[a-2]+")",{u:!1});this.b={name:d[a-2],value:d[a],T:d[a-1]};break;case 19:this.b=[d[a]];break;case 20:d[a-1].push(d[a]);this.b=d[a-1];break;case 21:d[a]in b.filters.dichotomies||
m("Invalid property name ("+d[a]+")",{u:!1});this.b={name:d[a],K:!1};break;case 22:d[a]in b.filters.dichotomies||m("Invalid property name ("+d[a]+")",{u:!1});this.b={name:d[a],K:!0};break;case 23:case 24:this.b=c}}function s(c,a,n,b){$.isArray(a)&&a.forEach(function(a){c=b.properties[a.name](c,a)});$.isArray(n)&&n.forEach(function(a){c=b.dichotomies[a.name](c,a)});return c}function t(c,a){return c.filter(function(c){return-1==a.indexOf(c)})}function y(c,a){return c.filter(function(c){return-1!=a.indexOf(c)})}
function q(c){function a(a,b){if(b.u)this.trace(a);else throw Error(a);}var n={},b=new z;if(this instanceof q)c&&"[object Object]"===Object.prototype.toString.call(c)&&(c.yy&&(n=c.yy),c.lexer&&(b=c.lexer),c.error&&(a=c.error));else throw Error("Parser called in static context; use new Parser() instead.");this.__proto__.parse=function(c,d){var k=[0],m=[null],f=[],q="",v=0,s=0,t=0,y=f.slice.call(arguments,1);b.N(c);b.o=n;n.R=b;n.F=this;n.data=d;"undefined"==typeof b.a&&(b.a={});var A=b.a;f.push(A);
for(var z=b.options&&b.options.r,e,B,p,h,r={},w,l;;){p=k[k.length-1];if(C[p])h=C[p];else{if(null===e||"undefined"==typeof e)e=void 0,e=b.C()||1,"number"!==typeof e&&(e=G[e]||e);h=x[p]&&x[p][e]}if("undefined"===typeof h||!h.length||!h[0]){var D="";l=[];for(w in x[p])u[w]&&2<w&&l.push("'"+u[w]+"'");D=b.s?"Parse error on line "+(v+1)+":\n"+b.s()+"\nExpecting "+l.join(", ")+", got '"+(u[e]||e)+"'":"Parse error on line "+(v+1)+": Unexpected "+(1==e?"end of input":"'"+(u[e]||e)+"'");a(D,{text:b.match,H:u[e]||
e,D:b.d,S:A,P:l})}if(h[0]instanceof Array&&1<h.length)throw Error("Parse Error: multiple actions possible at state: "+p+", token: "+e);switch(h[0]){case 1:k.push(e);m.push(b.f);f.push(b.a);k.push(h[1]);e=null;B?(e=B,B=null):(s=b.l,q=b.f,v=b.d,A=b.a,0<t&&t--);break;case 2:l=E[h[1]][1];r.b=m[m.length-l];r.w={n:f[f.length-(l||1)].n,i:f[f.length-1].i,m:f[f.length-(l||1)].m,g:f[f.length-1].g};z&&(r.w.j=[f[f.length-(l||1)].j[0],f[f.length-1].j[1]]);p=F.apply(r,[q,s,v,n,h[1],m,f,a].concat(y));if("undefined"!==
